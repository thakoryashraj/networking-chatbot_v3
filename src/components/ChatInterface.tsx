...
export const ChatInterface = () => {
  ...
  // Cleanup function to prevent duplicate chats
  useEffect(() => {
    return () => {
      if (chatContainer) {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-chat">
      ...
      <div className="flex-1 overflow-hidden">
        <div id="n8n-chat" className="h-full w-full n8n-chat-container"></div>
      </div>
      ...
      <style>{`
        ...
        /* Ensure only one chat instance and proper containment */
        #n8n-chat {
          position: relative;
          overflow: hidden;
        }

        /* Hide any duplicate chat instances */
        .n8n-chat-container:not(#n8n-chat .n8n-chat-container) {
        ...
        /* Hide any n8n welcome screen or overlay */
        .n8n-chat-container .n8n-chat-welcome,
        .n8n-chat-container .n8n-chat-overlay {
          display: none !important;
        }
